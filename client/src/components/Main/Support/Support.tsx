...
function Support() {
  return (
    <section className="section section--black" id="messages">
      <div className="contain">
        <div className="limit limit--m">
          <div className="duo duo--reverse">
            <div className="duo__item col-sup">
              <div className="feature">
                <h2>Подпишись!</h2>
                <p>
                  Не забудь подписаться на наш telegram канал и другие
                  социальные сети, чтобы не пропустить новые объявления и важные
                  новости.
                </p>
              </div>
